...
```{r}
lm5 <- lm(price ~ sqft_living + bedrooms + waterfront + yr_built, data = house_trim)
...
```{r}
lm6 <- lm(price ~ sqft_living + bedrooms + waterfront + yr_built + 
            sqft_living:bedrooms, data = house_trim)
